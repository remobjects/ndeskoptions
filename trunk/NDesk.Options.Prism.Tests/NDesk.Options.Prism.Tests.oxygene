<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="3.5">
  <PropertyGroup>
    ...
    <RootNamespace>NDesk.Options.Prism.Tests</RootNamespace>
    <StartupClass />
    <OutputType>library</OutputType>
    <AssemblyName>NDesk.Options.Prism.Tests</AssemblyName>
    ...
    <Name>NDesk.Options.Prism.Tests</Name>
  ...
  <ItemGroup>
    <ProjectReference Include="..\NDesk.Options.Prism\NDesk.Options.Prism.oxygene">
      <Name>NDesk.Options.Prism</Name>
      <Project>{eb1a6efb-37f3-4905-a926-454c8eff194d}</Project>
      <Private>True</Private>
      <HintPath>..\NDesk.Options.Prism\bin\Debug\NDesk.Options.Prism.dll</HintPath>
    </ProjectReference>
  </ItemGroup>
